<div id="paypal-button-container-P-74616681K0259400UNHE7LVY"></div>
  ...
  paypal.Buttons({
      ...
      createSubscription: function(data, actions) {
        return actions.subscription.create({
          ...
          plan_id: 'P-74616681K0259400UNHE7LVY'
        });
      },
      onApprove: function(data, actions) {
        alert(data.subscriptionID); // You can add optional success message for the subscriber here
      }
  }).render('#paypal-button-container-P-74616681K0259400UNHE7LVY'); // Renders the PayPal button
</script>
