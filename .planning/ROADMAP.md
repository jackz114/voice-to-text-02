...
- [x] 02-02-PLAN.md — Library UI (/library page, sidebar, list/grid view, detail modal, delete)
- [x] 02-03-PLAN.md — Review API routes + ts-fsrs (GET /api/review/today, POST /api/review/rate)
- [x] 02-04-PLAN.md — Review Session UI (/review page, swipe cards, rating buttons, undo bar)
