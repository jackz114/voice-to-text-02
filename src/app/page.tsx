    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-[#E8E0D5]">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-xl font-bold tracking-tight text-[#1C1C1C]">Recallmemo</span>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h1 className="text-5xl lg:text-6xl font-bold tracking-tight leading-tight mb-6 text-[#1C1C1C]">
              Your voice, in <span className="text-[#B8860B]">any language.</span>
            </h1>
            <p className="text-lg text-[#6B5B4F] leading-relaxed mb-8 max-w-lg">
              ...
              transcription. Transcribe, translate, and preserve your voice across any language — in
              real time.
            </p>
          ...
          {/* Right Waveform Translation Demo */}
...
function WaveformDemo() {
    ...
    const draw = () => {
      ...
      for (let wave = 0; wave < 4; wave++) {
        ...
        for (let x = 0; x < width; x++) {
          const y =
            height / 2 + Math.sin((x / 20) * (wave + 1) + phase + wave * 0.5) * heights[wave];
  ...
  const translations = [
    { from: "English", to: "Mandarin", text: "Hello, how are you today?" },
    { from: "English", to: "Español", text: "Hello, how are you today?" },
    { from: "English", to: "Japanese", text: "Hello, how are you today?" },
  ...
  return (
    <div className="space-y-4">
      {/* Waveform Animation */}
      <canvas ref={canvasRef} width={500} height={100} className="w-full h-24 rounded-lg" />
      ...
      <div className="bg-[#F5EFE6] rounded-lg p-4 border border-[#E8E0D5]">
        <p className="text-sm text-[#1C1C1C] font-medium">Hello, how are you today?</p>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-[#6B5B4F] max-w-xl mx-auto">
            Everything you need to transcribe, translate, and manage your audio content at scale.
          </p>
        </div>
...
function FeatureCard({
  ...
  return (
    <div className="p-6 rounded-2xl bg-white border border-[#E8E0D5] hover:border-[#D4A843] transition-colors shadow-sm">
      ...
      <p className="text-sm text-[#6B5B4F] leading-relaxed">{description}</p>
    </div>
  );
}
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-[#6B5B4F] max-w-lg mx-auto">
            From podcasters to researchers, Recallmemo adapts to your workflow.
          </p>
        </div>
...
function DashboardMock() {
  ...
  const waveHeights = [
    30, 55, 40, 70, 45, 60, 35, 80, 50, 65, 75, 40, 55, 45, 30, 65, 50, 75, 40, 60, 35, 70, 55, 45,
    80, 30, 65, 50, 75, 40, 60, 35, 70, 45, 55, 30, 65, 50, 75, 40,
  ];
            ...
            >
              {i === 0 && (
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m6 7.5v3.75m-6.75 0h7.5M12 15.75a3 3 0 01-3-3V4.5a3 3 0 116 0v8.25a3 3 0 01-3 3z"
                />
              )}
              {i === 1 && (
                <path
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            <Image
              ...
              className="object-contain"
            />
            <span className="text-lg font-bold text-[#1C1C1C]">Recallmemo</span>
          </div>

          <div className="flex items-center gap-6 text-sm text-[#9C8E80]">
            <a href="/privacy-policy" className="hover:text-[#1C1C1C] transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="hover:text-[#1C1C1C] transition-colors">
              Terms of Service
            </a>
            <a href="mailto:zhengwei1245836984@gmail.com" className="hover:text-[#1C1C1C] transition-colors">
              Contact
            </a>
          </div>

          <p className="text-xs text-[#9C8E80]">
            © {new Date().getFullYear()} Recallmemo. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
