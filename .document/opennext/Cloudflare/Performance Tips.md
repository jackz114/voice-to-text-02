...
General
You should regularly update to the latest available version of @opennextjs/cloudflare to benefit from the latest performance and security updates.
...
To get the most out of caching, you should start by reading how Next.js implements caching. The "Caching in Next.js" guide is a good place to start.
...
See the Cloudflare documentation for a detailed explanation of the default and the syntax.
...
Once the app is running, follow the steps from the Workers doc to record a CPU profile.
