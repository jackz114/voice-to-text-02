...
create-next-app — a Next.js project bootstrapped with create-next-app.
api — a minimal Next.js project with a single API route
middleware — a minimal Next.js project using middleware
vercel-blog-starter — a blog project using SSG
