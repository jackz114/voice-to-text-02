Custom Worker
The worker generated by the Cloudflare adapter only exports a fetch handler.

Sometimes your application needs to expose another type of handler (i.e. a scheduled handler) or export a Durable Object. This can be achieved by creating a custom worker.
