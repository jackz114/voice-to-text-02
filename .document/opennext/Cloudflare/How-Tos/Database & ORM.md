...
If you encounter issue with a specific library, please open an issue on the OpenNext GitHub repository.

Drizzle ORM
Drizzle is a TypeScript ORM for SQL databases. It is designed to be lightweight and easy to use, making it a great choice for Cloudflare Workers. There is not much specific to configure in Drizzle, but there is one important thing to note is that you don't want to have a global client.
...
Prisma ORM
Prisma is a popular ORM for Node.js and TypeScript. It is designed to be easy to use and provides a lot of features out of the box. However, there are some subtleties to be aware of when using Prisma in Cloudflare Workers.
